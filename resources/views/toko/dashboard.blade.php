            ...
            <div class="col-md-4">
                <div class="card shadow-sm border-0">
                    <div class="card-body text-center">
                        ...
                        <a href="{{ route('vendor.products.index') }}" class="btn btn-outline-primary mt-2">Kelola
                            Produk</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card shadow-sm border-0">
                    <div class="card-body text-center">
                        ...
                        <a href="{{ route('vendor.reports.index') }}" class="btn btn-outline-success mt-2">Lihat Laporan</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card shadow-sm border-0">
                    <div class="card-body text-center">
                        ...
                        <a href="{{ route('vendor.shops.index') }}" class="btn btn-outline-warning mt-2">Kelola Toko</a>
                    </div>
                </div>
            </div>
        </div>
